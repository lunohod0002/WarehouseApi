...
if (settings.MODE == "TEST"):
    ...
    DATABASE_URL = f"postgresql+asyncpg://{settings.DB_USER}:{settings.DB_PASS}@{settings.DB_PASS}:{settings.DB_PORT}/{settings.DB_NAME}"
    DATABASE_PARAMS = {}
elif (settings.MODE == "PROD"):
    DATABASE_URL = f"postgresql+asyncpg://{settings.DB_USER}:{settings.DB_PASS}@db:{settings.DB_PORT}/{settings.DB_NAME}"
    DATABASE_PARAMS = {}
